...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        # print('self._global_params.num_classes', self._global_params.num_classes)
        # sys.exit(0)
...
def efficientnet(**kwargs):
    model_name = kwargs.get('net_version', 'efficientnet-b7')
    override_params = kwargs.get('override_params', None)
